...
public class PeriodicTableLayoutEditor : EditorWindow
{
    ...
    private static readonly Dictionary<int, int> ElementCategory = new Dictionary<int, int>
    {
        ...
        {20021,0},{20028,0},{20044,0},{20045,0},{20062,0}, // F Cl Se Br I
        ...
        // 5 类金属
        {20019,5},{20025,5},{20042,5},{20043,5},{20060,5},{20061,5},{20092,5},{20093,5},{20125,5}, // B Si Ge As Sb Te Po At Ts
    ...
    private Color[] CategoryColors = new Color[]
    {
        ...
        new Color(0.95f, 0.50f, 0.20f), // 1 碱金属    橙
        new Color(0.20f, 0.75f, 0.70f), // 2 碱土金属  青绿
        new Color(0.25f, 0.55f, 0.90f), // 3 过渡金属  蓝
        new Color(0.65f, 0.35f, 0.80f), // 4 后过渡金属 紫
        new Color(0.30f, 0.75f, 0.35f), // 5 类金属    绿
        new Color(0.90f, 0.30f, 0.45f), // 6 稀有气体  粉红
        new Color(0.45f, 0.75f, 0.95f), // 7 镧系      浅蓝
        new Color(0.75f, 0.60f, 0.90f), // 8 锕系（原来漏掉了）浅紫  ← 已有
        new Color(0.85f, 0.70f, 0.50f), // 9 锕系      棕黄  ← 新增这行
    };
